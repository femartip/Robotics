        ...
        while True:
            ...
            try:
                ...
                for mannequin in ('mannequin_NW', 'mannequin_NE', 'mannequin_SE', 'mannequin_SW'):
                    ...
                    man_x = np.cos(man_ang)*man_dist
                    man_y = np.sin(man_ang)*man_dist

                    mannequins.append(man_x + random.gauss(0, self.NOISE_STDDEV))
                    mannequins.append(man_y + random.gauss(0, self.NOISE_STDDEV))
